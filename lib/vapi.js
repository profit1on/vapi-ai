...
export const makeCall = async (phoneNumberId, customerData, assistantOverrides) => {
    const requestBody = {
        phoneNumberId,
        customer: {
            number: customerData.number,
            name: customerData.name,
            extension: customerData.extension || "", // Optional extension
        },
        assistantId, // Use the assistantId from the environment variable
        assistantOverrides, // Include the assistantOverrides
    };
