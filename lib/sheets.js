...
export const processEndCallReport = async (report) => {
    ...
    // Only update the phoneCallProviderId, callId, ended reason, duration, price, and recording URL
    await updateLeadInfo(rowIndex, '', phoneCallProviderId, callId); // Pass an empty string for status
