...
export const updateCellO = async (rowIndex, value) => {
    ...
    const cellORange = `Lead list!O${rowIndex}`; // Update cell in column O
    await sheets.spreadsheets.values.update({
        spreadsheetId,
        range: cellORange,
        valueInputOption: 'RAW',
...
export const updateCellQ = async (rowIndex, value) => {
    ...
    // Update the value in column Q
    const cellQRange = `Lead list!Q${rowIndex}`; // Update cell in column Q
    await sheets.spreadsheets.values.update({
        spreadsheetId,
        range: cellQRange,
        valueInputOption: 'RAW',
...
export const updateCellP = async (rowIndex, value) => {
    ...
    // Update the value in column P
    const cellPRange = `Lead list!P${rowIndex}`; // Update cell in column P
    await sheets.spreadsheets.values.update({
        spreadsheetId,
        range: cellPRange,
        valueInputOption: 'RAW',
